...
export function serviceHomePage(
  ...
  const statisticsOperation = metadata.features.statistics
    ...
    : "";
  const eventsOperation = metadata.features.events
    ? '<a href="/events"><strong>Events</strong><span>Publish and read immutable typed JSON events in your isolated AittaDB namespace.</span></a>'
    : "";
...
export function sessionPage(
  ...
  const userInfoOperation = userInfoEnabled
    ...
    : "";
  const eventsOperation = eventsEnabled
    ? `<a href="/events"><strong>My events</strong><span>Publish and read immutable typed JSON events in this identity's isolated browser namespace.</span></a>`
    : "";
