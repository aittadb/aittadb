  ...
  paths: {
    "/": {
      get: {
        ...
        description:
          "Returns hypermedia service metadata, including AittaDB's licensing posture and current ChatGPT Sites platform dependency, or a concise browser overview when the request prefers HTML.",
        responses: {
          "200": {
